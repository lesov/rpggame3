...
export interface Firekeeper {
  ...
  age: number;
  wayFee?: number; // portal fee at the capital hall, gold, when anchored there
...
export const FIREKEEPERS: Record<string, Firekeeper> = {
  ...
  'Kozeslelian Khaganate': { name: 'Firekeeper Deretslav', race: 'Human (Rohand)', age: 63, wayFee: 50, bio: 'A schemer who trusts no one; his wardens anchor the cheapest great Way in the world at Mememil. Keeps meticulous ledgers of which caravans the Khagan’s men have "inspected."' },
  ...
  'Grand Duchy of Mathathremo': { name: 'Firekeeper Barazan', race: 'Dwarf (Khiz)', age: 219, wayFee: 200, bio: 'Shrewd and unsmiling; earned her Hearth-rank sealing a delve beneath the Basheva Mountains that had eaten three companies before hers.' },
  'Ghronese Theocracy': { name: 'Firekeeper Gandur', race: 'Dwarf (Khiz)', age: 264, wayFee: 150, isSpeaker: true, bio: 'Speaker of the whole Campfire; beloved by the common folk and the only living soul to have crossed the Gabaramunz Waste on foot in high summer. Governs the greatest fellowship in the world from the least realm in the East.' },
  ...
  'Republic of Nelkug': { name: 'Firekeeper Brinollu', race: 'Wood Elf (Metheine)', age: 289, wayFee: 200, bio: 'The youngest elf ever raised to a Firekeeper’s chair; a schemer who made his fortune before his fame delving Basheva vaults for the republic’s merchant houses. Keeps the busiest Way in the East.' },
  'Duchy of Sahlumerin': { name: 'Firekeeper Maldrinos', race: 'Dragonborn (Naliolazar)', age: 58, wayFee: 200, bio: 'Quick to anger and slow to forgive; wears the scorch-scars of the Gondon fire-caves he cleared to win his Hearth.' },
  ...
  'Principality of Shun': { name: 'Firekeeper Thelhoneas', race: 'Wood Elf (Thyran)', age: 588, wayFee: 200, bio: 'Keeps the flagship hall of the world at Lin Arlor; patient as stone, he arbitrated the last Dousing and crowns still lower their voices around him.' },
  'Grand Duchy of Kin': { name: 'Firekeeper Irerius', race: 'Wood Elf (Thyran)', age: 601, wayFee: 200, bio: 'Shrewd and unsmiling; cleared the Guallana barrow-roads so long ago the ballads disagree on his name. Spends his centuries’ patience keeping nineteen restless blades out of Grand Duke Itheas’s four wars.' },
  ...
  'Principality of Guzah': { name: 'Firekeeper Sathlond', race: 'Wood Elf (Thyran)', age: 419, wayFee: 150, bio: 'Haunted by a Rhakorash fire-season his post could not outrun; has drilled evacuation-craft into the western halls ever since, to the great profit of towns that never learn whom to thank.' },
  'Grand Duchy of Nolon': { name: 'Firekeeper Yaeluthei', race: 'High Elf (Mythlerion)', age: 502, wayFee: 100, bio: 'Devout in the Schism’s quiet fashion; hunts the Yaelunor Taiga’s winter-things with a longbow older than most realms.' },
  'Nakinb Theocracy': { name: 'Firekeeper Sheorien', race: 'Wood Elf (Thyran)', age: 433, wayFee: 150, bio: 'Pragmatic and coldly efficient; made his name breaking the Zuran raider-princes with contracts rather than crusades, to Hierarch Hanlenor’s theological irritation.' },
  ...
  'Sio Empire': { name: 'Firekeeper Talaran', race: 'Leonin (Thakar)', age: 47, wayFee: 50, bio: 'Feared even by allies; took the Rhakorash death-pride’s contract alone after it broke two full companies. The pelt hangs in her hall, and she does not discuss it.' },
  'Kingdom of Kalaghryka': { name: 'Firekeeper Khashor', race: 'Leonin (Thakar)', age: 44, wayFee: 200, bio: 'An outlander in a kingdom at war with his birth-empire; the Compact made flesh. Scarred from a dozen campaigns — all against monsters, he notes, before anyone asks.' },
  ...
  'Kingdom of Khizdum': { name: 'Firekeeper Ryammar', race: 'Wood Elf (Thyran)', age: 468, wayFee: 150, bio: 'Famed for reckless courage; his Hearth-contract, taken alone against everyone’s advice, emptied a Guallana deep-warren the duchy’s army had walled up and abandoned. Keeps the second-greatest hall of the West.' },
  ...
  'Shaterian Theocracy': { name: 'Firekeeper Timholt', race: 'Gnome (Litbarow)', age: 182, wayFee: 150, bio: 'More scholar than warrior; mapped the Slow Forest deeps with instruments of his own devising, several of which the Guild has since prudently banned. Has had his refusal of the crusader-tithe printed, and hands it out.' },
};
